...
const List<FeatureDefinition> tradingFeatures = [
  ...
  FeatureDefinition(
    ...
    title: 'Watchlist',
    description:
        'A watchlist requires an authenticated watchlist endpoint plus live '
        'quote updates; neither is exposed by the backend yet.',
    expectedData: ['Instruments', 'Quote updates', 'Stale state'],
    permission: Permissions.tradingView,
  ),
  FeatureDefinition(
    id: 'charts',
    title: 'Charts',
    description:
        'Charting requires historical candle/indicator endpoints, which are '
        'not exposed over the authenticated API yet.',
    expectedData: ['Candles', 'Volume', 'Timeframe', 'Indicators'],
    permission: Permissions.tradingView,
  ),
  FeatureDefinition(
    id: 'orders',
  ...
  FeatureDefinition(
    ...
    title: 'Settings',
    description:
        'Desktop settings (theme, workspace, shortcuts) are local-only; no '
        'backend settings endpoint is required. This screen is a placeholder.',
    expectedData: ['Theme', 'Workspace layout', 'Keyboard shortcuts'],
